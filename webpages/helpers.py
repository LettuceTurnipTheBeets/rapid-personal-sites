...
def generate_image_url(image, filter_spec):
    ...
    # http://docs.wagtail.io/en/latest/advanced_topics/images/image_serve_view.html 
...
def generate_signature(image_id, filter_spec, key=None):
    # Copied from wagtail.wagtail.view.serve.py to avoid a
    # "Models aren't loaded yet" error.
    if key is None:
